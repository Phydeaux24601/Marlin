...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Predator 
  #define DEFAULT_bedKp 55.53
  #define DEFAULT_bedKi 11.09
  #define DEFAULT_bedKd 185.28
...
#define DELTA
  ...
  #define DELTA_HEIGHT 437.7            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.08, -0.41, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 226.82              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.14, -0.11, -0.03 } // Get these values from G33 auto calibrate
