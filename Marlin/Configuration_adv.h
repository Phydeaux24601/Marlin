...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  282, 10 }, { 10,  10 } }
  ...
  //#define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_AMP 1.3       // Use a value > 1.0 NOTE: This may cause instability!
  #endif
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
    ...
    #define X_CURRENT_HOME  (2*X_CURRENT/3)  // (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT_HOME  (2*Y_CURRENT/3)
    #define Y_MICROSTEPS     16
